...
public class LoadCSVHandler implements Route {
    ...
    public Object handle(Request request, Response response) throws Exception {
        ...
        //errors that may occur when a parameter as specified above is empty or when both of them are empty
        if ((filepath == null) && (headers != null)) {
            ...
            responseMap.put("query_filepath", filepath);
            responseMap.put("query_headers", headers);
            responseMap.put("message", "please indicate whether the CSV has headers by typing/inputting true or false into the headers param");
            return adapter.toJson(responseMap);
        } else if ((filepath == null) && (headers == null)) {
            responseMap.put("result", "error_bad_request");
            responseMap.put("query_filepath", filepath);
            responseMap.put("query_headers", headers);
            responseMap.put("message", "please input a filepath and indicate whether the CSV has headers by typing/inputting true or false into the headers param");
            return adapter.toJson(responseMap);
        }
        ...
        try {
            ...
            responseMap.put("query_filepath", filepath);
            responseMap.put("query_headers", headers);
            responseMap.put("message", "there was an error that occurred while trying to parse the CSV file");
            return adapter.toJson(responseMap);
        } catch (FactoryFailureException e) {
            responseMap.put("result", "error_cannot_parse");
            responseMap.put("query_filepath", filepath);
            responseMap.put("query_headers", headers);
            responseMap.put("message", "there are rows where the numbers of columns are not consistent with the rest of the file");
            return adapter.toJson(responseMap);
        }
