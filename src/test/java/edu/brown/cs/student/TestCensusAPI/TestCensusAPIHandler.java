...
//    assertEquals("90.2", miamiResponseBody.get("percentage of people that have broadband
// access"));
//    miamiConnection.disconnect();
//
//    // looking for the other item in the list for the data
//    HttpURLConnection middlesexConnection = tryRequest(new stateCounty("new_jersey",
// "middlesex"));
...
//    assertEquals(
//        "Please input a state and county to get data for. If there are spaces in the names of
// either, please replace them with _",
...
//    assertEquals(
//        "Please input a state to get data for. If there are spaces in the name, please replace
// them with _",
...
//    assertEquals(
//        "Please input a county to get data for. If there are spaces in the name, please replace
// them with _",
