...
public class TestSearchCSVHandler {
    ...
    public void testSearchCSVRequestSuccess() throws IOException {
        ...
        HttpURLConnection searchConnection = tryRequest("searchcsv?searchFor=White&columnIdentifier=Data_Type&useColumnHeaders=true" );
        assertEquals(200, searchConnection.getResponseCode());
        Map<String, Object> responseBody = adapter.fromJson(new Buffer().readFrom(searchConnection.getInputStream()));
    ...
    public void testSearchCSVRequestFail_MissingAllParameters() throws IOException {
        ...
        HttpURLConnection searchConnection = tryRequest("searchcsv?searchFor=&columnIdentifier=&useColumnHeaders=" );
        assertEquals(200, searchConnection.getResponseCode());
        Map<String, Object> responseBody = adapter.fromJson(new Buffer().readFrom(searchConnection.getInputStream()));
    ...
    public void testSearchCSVRequestFail_MissingSearchParameter() throws IOException {
        ...
        HttpURLConnection searchConnection = tryRequest("searchcsv?searchFor=&columnIdentifier=Data_Type&useColumnHeaders=true" );
        assertEquals(200, searchConnection.getResponseCode());
        Map<String, Object> responseBody = adapter.fromJson(new Buffer().readFrom(searchConnection.getInputStream()));
        assertEquals("error_bad_request", responseBody.get("result"));
        searchConnection.disconnect();
    ...
    public void testSearchCSVRequestFail_MissingUseColumnHeadersParameter() throws IOException {
        ...
        HttpURLConnection searchConnection = tryRequest("searchcsv?searchFor=White&columnIdentifier=Data_Type&useColumnHeaders=" );
        assertEquals(200, searchConnection.getResponseCode());
        Map<String, Object> responseBody = adapter.fromJson(new Buffer().readFrom(searchConnection.getInputStream()));
        assertEquals("error_bad_request", responseBody.get("result"));
        searchConnection.disconnect();
    ...
    public void testSearchCSVRequestFail_LoadNotPerformed() throws IOException {
        HttpURLConnection viewConnection = tryRequest("searchcsv?searchFor=White&columnIdentifier=Data_Type&useColumnHeaders=true");
    ...
    public void testSearchCSVRequestFail_InvalidColumnIdentifier() throws IOException {
        ...
        HttpURLConnection searchConnection = tryRequest("searchcsv?searchFor=White&columnIdentifier=roblox&useColumnHeaders=true" );
        assertEquals(200, searchConnection.getResponseCode());
        Map<String, Object> responseBody = adapter.fromJson(new Buffer().readFrom(searchConnection.getInputStream()));
    ...
    public void testSearchCSVRequestFail_InvalidUseColumnHeadersInput() throws IOException {
        ...
        HttpURLConnection searchConnection = tryRequest("searchcsv?searchFor=White&columnIdentifier=Data_Type&useColumnHeaders=roblox" );
        assertEquals(200, searchConnection.getResponseCode());
        Map<String, Object> responseBody = adapter.fromJson(new Buffer().readFrom(searchConnection.getInputStream()));
        assertEquals("error_bad_request", responseBody.get("result"));
        searchConnection.disconnect();
